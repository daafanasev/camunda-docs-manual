...
It has a `href` attribute and the value starts with `#` followed by the [decision id](../../reference/dmn/decision-table/_index.md#decision-id) of the required decision.
...
[id]: ../../reference/dmn/decision-table/_index.md#decision-id" >}}
[name]: ../../reference/dmn/decision-table/_index.md#decision-name" >}}
