...
See the [processes.xml](../../user-guide/process-applications/the-processes-xml-deployment-descriptor.md) section of the [User Guide](../../user-guide/_index.md) for more details.
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>boolean</td>
    <td>
        If true, previous versions of the deployment are automatically resumed. See the <a href="../../user-guide/process-applications/the-processes-xml-deployment-descriptor.md#process-application-deployment" >}}">Process Application Deployment</a> section of the <a href="../../user-guide/_index.md" >}}">User Guide</a> for more details.
      <p>
        <strong>Default value:</strong>
        true.
      </p>
