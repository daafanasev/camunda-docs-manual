...
The size of the result set can be retrieved by using the [Get Authorization Count](../../reference/rest/authorization/get-query-count.md) method.
...
<table class="table table-striped">
  ...
  <tr>
    <td>type</td>
    <td>Filter by authorization type. (0=global, 1=grant, 2=revoke). See the <a href="../../user-guide/process-engine/authorization-service.md#authorization-type" >}}">User Guide</a> for more information about authorization types.</td>
  </tr>
  <tr>
    <td>userIdIn</td>
  ...
  <tr>
    <td>resourceType</td>
    <td>Filter by an integer representation of the resource type. See the <a href="../../user-guide/process-engine/authorization-service.md#resources" >}}">User Guide</a> for a list of integer representations of resource types.</td>
  </tr>
  <tr>
    <td>resourceId</td>
