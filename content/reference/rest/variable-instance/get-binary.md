...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>Variable with given id exists but does not serialize as binary data. See the <a href="../../reference/rest/overview/_index.md#error-handling" >}}">Introduction</a> for the error response format.</td>
  </tr>
  <tr>
