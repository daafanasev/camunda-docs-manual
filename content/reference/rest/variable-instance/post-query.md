...
[Get Variable Instances](../../reference/rest/variable-instance/get-query.md) method because it allows filtering by multiple variable instances of types `String`, `Number` or `Boolean`.
