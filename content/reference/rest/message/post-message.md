...
For more information about the correlation behavior, see the [Message Events](../../reference/bpmn20/events/message-events.md) section of the [BPMN 2.0 Implementation Reference](../../reference/bpmn20/_index.md).
...
<table class="table table-striped">
  ...
  <tr>
   ...
   <td>
    ...
    The processInstance with the properties as described in the <a href="../../reference/rest/process-instance/get.md" >}}">get single instance</a> method.
   </td>
  </tr>
  <tr>
   <td>execution</td>
   ...
   <td>
    ...
    The execution with the properties as described in the <a href="../../reference/rest/execution/get.md" >}}">get single execution</a> method.
   </td>
  </tr>
  <tr>
   <td>variables</td>
