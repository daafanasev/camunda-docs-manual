...
To modify a single process instance, use the [Modify Process Instance Execution State](../../reference/rest/process-instance/post-modification.md) method.
To execute a modification asynchronously, use the [Execute Modification Async (Batch)](../../reference/rest/modification/post-modification-async.md) method.
