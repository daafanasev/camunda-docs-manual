...
when using the [Get Filters](../../reference/rest/filter/get-query.md) method.
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      ...
      comparison is used. See the <a href="../../reference/rest/overview/_index.md#error-handling" >}}">Introduction</a> for the
