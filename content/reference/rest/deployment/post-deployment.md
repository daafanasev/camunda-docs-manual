...
<table class="table table-striped">
  ...
  <tr>
    <td>400</td>
    <td>application/json</td>
    <td>In case one of the bpmn resources cannot be parsed.  See the <a href="../../reference/rest/overview/_index.md#parse-exceptions" >}}">Introduction</a> for the error response format.</td>
  </tr>
</table>
