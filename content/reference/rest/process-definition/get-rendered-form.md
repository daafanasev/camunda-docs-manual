...
Retrieves the rendered form for a process definition. This method can be used for getting the HTML rendering of a [Generated Task Form](../../user-guide/task-forms/_index.md#generated-task-forms).
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>Process definition has no form field metadata defined. See the <a href="../../reference/rest/overview/_index.md#error-handling" >}}">Introduction</a> for the error response format.</td>
  </tr>
  <tr>
    <td>404</td>
    <td>application/json</td>
