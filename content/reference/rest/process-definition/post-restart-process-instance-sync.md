...
use the [Restart Process Instance Async](../../reference/rest/process-definition/post-restart-process-instance-async.md) method.

For more information about the difference between synchronous and
asynchronous execution, please refer to the related
section of the [user guide](../../user-guide/process-engine/process-instance-restart.md#execution).
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>Skip execution of <a href="../../user-guide/process-engine/variables.md#input-output-variable-mapping" >}}">input/output variable mappings</a> for activities that are started as part of this request.</td>
  </tr>
   <tr>
