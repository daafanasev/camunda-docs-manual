...
<table class="table table-striped">
  ...
  <tr>
    <td>500</td>
    <td>application/json</td>
    <td>The group could not be created due to an internal server error. See the <a href="../../reference/rest/overview/_index.md#error-handling" >}}">Introduction</a> for the error response format.</td>
  </tr>
</table>
