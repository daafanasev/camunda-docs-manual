...
This method takes the same message body as the [Get Instances (POST)](../../reference/rest/process-instance/post-query.md) method
and therefore it is slightly more powerful than the [Get Instance Count](../../reference/rest/process-instance/get-query-count.md) method.
