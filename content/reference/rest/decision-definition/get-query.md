...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>Number</td>
    <td>History time to live value of the decision definition. Is used within <a href="../../user-guide/process-engine/history.md#history-cleanup">}}">History cleanup</a>.</td>
  </tr>
</table>
