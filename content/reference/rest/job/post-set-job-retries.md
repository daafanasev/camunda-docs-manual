...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      ...
      <a href="../../reference/rest/job/post-query.md#request-body" >}}">
        Get Jobs (POST)
      </a> method.
    </td>
  </tr>
...
<table class="table table-striped">
  ...
  <tr>
    <td>400</td>
    <td>application/json</td>
    <td>Returned if some of the query parameters are invalid, for example if neither processInstanceIds nor processInstanceQuery is present. Or if the retry count is not specified. See the <a href="../../reference/rest/overview/_index.md#error-handling" >}}">Introduction</a> for the error response format.</td>
  </tr>
</table>
