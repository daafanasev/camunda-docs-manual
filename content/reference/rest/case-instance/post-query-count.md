...
This method takes the same message body as the [Get Case Instance (POST)](../../reference/rest/case-instance/post-query.md) method
and therefore it is slightly more powerful than the [Get Case Instance Count](../../reference/rest/case-instance/get-query-count.md) method.
