...
This method is slightly more powerful than the [Get External Tasks](../../reference/rest/external-task/get-query.md) method because it allows to specify a hierarchical result sorting.
