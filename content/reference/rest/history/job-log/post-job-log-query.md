...
This method is slightly more powerful than the [Get Job Logs](../../reference/rest/history/job-log/get-job-log-query.md) method because it allows filtering by historic job logs values of the different types `String`, `Number` or `Boolean`.
