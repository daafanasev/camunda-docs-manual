...
size of the result set can be retrieved by using the [Get Historic Decision Instance Count](../../reference/rest/history/decision-instance/get-decision-instance-query-count.md) method.
