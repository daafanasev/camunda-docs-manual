...
The size of the result set can be retrieved by using the [Get External Task Log Count](../../reference/rest/history/external-task-log/get-external-task-log-query-count.md) method.
