...
The size of the result set can be retrieved by using the [Get Process Instance Count](../../reference/rest/history/process-instance/get-process-instance-query-count.md) method.
