...
The size of the result set can be retrieved by using the [Get Cleanable Case Instance Report Count](../../reference/rest/history/case-definition/get-cleanable-case-instance-report-count.md) method.
