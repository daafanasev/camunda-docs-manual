...
result set can be retrieved by using the [Get Historic Case Activity Instance Count](../../reference/rest/history/case-activity-instance/get-case-activity-instance-query-count.md) method.
