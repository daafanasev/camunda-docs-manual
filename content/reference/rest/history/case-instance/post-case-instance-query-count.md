...
This method takes the same message body as the [Get Historic Case Instances (POST)](../../reference/rest/history/case-instance/post-case-instance-query.md) method and therefore it is slightly more powerful than the [Get Historic Case Instance Count](../../reference/rest/history/case-instance/get-case-instance-query-count.md) method.
