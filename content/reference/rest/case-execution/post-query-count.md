...
This method takes the same message body as the [Get Case Executions (POST)](../../reference/rest/case-execution/post-query.md) method
and therefore it is slightly more powerful than the [Get Case Execution Count](../../reference/rest/case-execution/get-query-count.md) method.
