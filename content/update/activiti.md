...
Once done with the migration, the [minor version update guides](../../update/minor/_index.md) show how to update from 7.0 to the latest Camunda version.
...
*   The `activiti:` [Custom Extensions](../../reference/bpmn20/custom-extensions/_index.md) are kept.
