...
* [Transient Variables](../../user-guide/process-engine/variables.md#transient-variables)
* [Long Polling for Fetch and Lock External Tasks](../../user-guide/process-engine/external-tasks.md#long-polling-to-fetch-and-lock-external-tasks)
* [Conditional start events](../../reference/bpmn20/events/conditional-events.md#conditional-start-event)
* [Sending a payload when throwing a signal](../../reference/bpmn20/events/signal-events.md#passing-variables)
...
* [Apache Tomcat](../../update/minor/78-to-79/tomcat.md)
* [JBoss AS/Wildfly](../../update/minor/78-to-79/jboss.md)
* [IBM WebSphere](../../update/minor/78-to-79/was.md)
* [Oracle WebLogic](../../update/minor/78-to-79/wls.md)
...
1. Check [Version compatibility](../../user-guide/spring-boot-integration/version-compatibility.md) matrix in the docs. 
...
Please also check [Spring Boot Starter update guide](../../update/spring-boot-starter/_index.md).
...
runtimeService.setVariable(processInstanceId, "varName",
        Variables
          ...
          .create());
```
In this case you will need to use another serialization format (JSON or XML) or to explicitly enable Java serialization with the help of [this configuration parameter](../../reference/deployment-descriptors/tags/process-engine.md#javaSerializationFormatEnabled):
...
These attributes can be modifed in the [configuration file](../../webapps/cockpit/extend/configuration.md#historic-activity-instance-metrics)

# Throttle login attempts

We introduce a special mechanism for consecutive unsuccessful login attempts.
A user will be delayed in trying to login after an unsuccessful login attempt for a certain amount of time (in seconds). This delay is calculated through a formula, and the contributing values are configurable. Please read more in the [Identity service](../../user-guide/process-engine/identity-service.md#throttle-login-attempts) section.
