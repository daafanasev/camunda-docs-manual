...
* [Apache Tomcat](../../update/minor/74-to-75/tomcat.md)
* [JBoss AS/Wildfly](../../update/minor/74-to-75/jboss.md)
* [Glassfish](../../update/minor/74-to-75/glassfish.md)
* [IBM WebSphere](../../update/minor/74-to-75/was.md)
* [Oracle WebLogic](../../update/minor/74-to-75/wls.md)
...
* [New authorization related Configuration Options](../../user-guide/process-engine/authorization-service.md#configuration-options)
* [Authorization related Performance Considerations](../../user-guide/process-engine/authorization-service.md#performance-considerations)

# Custom styles

The HTML markup of the front-ends changed and some adjustments may be needed.
Read the [customization section](../../webapps/tasklist/configuration.md" >}}#logo-and-header-color) for more information.
