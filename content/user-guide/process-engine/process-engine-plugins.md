...
* in the [Camunda Platform Deployment Descriptors](../../reference/deployment-descriptors/_index.md) (bpm-platform.xml/processes.xml),
* in the [Wildfly configuration file](../../user-guide/runtime-container-integration/jboss.md) (standalone.xml/domain.xml),
* using [Spring Beans XML](../../user-guide/spring-framework-integration/_index.md#configure-a-process-engine-plugin-in-spring),
* in the [Camunda Platform Run YAML configuration files](../../user-guide/camunda-bpm-run.md#process-engine-plugin-registration)
* programatically.
