...
The Camunda Platform on Apache Tomcat 9.x uses the default job executor. The default [job executor](../../user-guide/process-engine/the-job-executor.md) uses a ThreadPoolExecutor which manages a thread
