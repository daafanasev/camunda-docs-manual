...
[external task forms](../../user-guide/task-forms/_index.md#external-task-forms).
 ...
 *   starts the User Task in the process engine, meaning the bean sets the start date and assigns the task to the CDI business process scope (see [CDI Integration](../../user-guide/cdi-java-ee-integration/_index.md) for details).
