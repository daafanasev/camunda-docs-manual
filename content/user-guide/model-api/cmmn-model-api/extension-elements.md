...
[Custom extension elements](../../reference/cmmn11/custom-extensions/_index.md) are a standardized way to extend the CMMN model.
The [Camunda extension elements](../../reference/cmmn11/custom-extensions/camunda-elements.md) are fully implemented in the CMMN model API but unknown extension elements can also easily be accessed and added.
