...
* **Variables** - Specify which variables are displayed in the [filter results](../../webapps/tasklist/dashboard.md#filter-results) section of the [dashboard](../../webapps/tasklist/dashboard.md). Setting variables here has no influence on which tasks are displayed. To set the variables, you need to insert a *Name*, which is the coded name of the variable, and a *Label*, which defines what the variable will be named in the [filter results](../../webapps/tasklist/dashboard.md#filter-results).
