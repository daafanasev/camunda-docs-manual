...
Depending on whether you have defined a [start form](../../user-guide/task-forms/_index.md) for your process it will be displayed now. Otherwise you get a notification that no form has been defined for starting the process. In this case, a [generic start form](../../user-guide/task-forms/_index.md#generic-task-forms) will be displayed and Tasklist will offer the option of adding variables to the process instance.
